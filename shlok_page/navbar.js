...
( () =>
{
  let dropMenuLinksContent = `
     <!-- Row - 1  -->
        ...
        <img src="../Images/logo2.png" alt="" class="h-36 w-36 mx-auto" />
        ...
        <div class="">
          ...
          <a class="flex group items-center relative font-semibold ease-in-out duration-300 pb relative after:content-[''] after:bottom-0 after:h-1 after:w-0 after:left-0 after:absolute after:bg-indigo-600 hover:after:w-full after:ease-in-out after:duration-300 "
          href="../Importance of Sloks/Great People.html">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
            class="h-3 w-3 group-hover:text-indigo-600">
            <path fill-rule="evenodd"
              d="M4.72 3.97a.75.75 0 011.06 0l7.5 7.5a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L11.69 12 4.72 5.03a.75.75 0 010-1.06zm6 0a.75.75 0 011.06 0l7.5 7.5a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 11-1.06-1.06L17.69 12l-6.97-6.97a.75.75 0 010-1.06z"
          ...
          <span class="text-md p-3 group-hover:text-indigo-600">Power of Sloks</span>
        </a>
  ...
  let navbarContent = `
       <div class="leftSection">
              <a class="flex items-center" href="../index.html">
                <img src="../Images/logo2.png" alt="SoulSync Logo" class="w-12 h-12 hover:animate-spin " />
                <span
                  class="ml-3 text-base lg:text-2xl uppercase font-semibold projectName tracking-widest ease-in-out duration-300 hover:text-indigo-600">SoulSync</span>
              </a>
            ...
            <div class="rightSection pr-4">
              ...
              <div>
                <ul class="hidden md:flex items-center gap-10 uppercase text-xs font-semibold tracking-wider ">
                  ...
                  <li>
                  <a href="../Importance of Sloks/Great People.html"
                    class="pb-3 hover:text-indigo-600 relative font-semibold after:content-[''] after:bottom-0 after:h-1 after:w-0 after:left-0 after:absolute after:bg-indigo-600 hover:after:w-full after:ease-in-out after:duration-300 ">Power
                    of
                    Sloks </a>
                </li>
  ...
  let footerContent = `
    <!-- NewsLetter  -->
          ...
          <div class="mb-1 text-center lg:text-left w-1/2">
              ...
              <p style = "color:white">Get weekly updates regarding SoulSync.</p>
            </div>
          ...
          <div class="mt-8 siteNav flex flex-col lg:flex-row ">
            ...
            <div class="flex flex-col lg:flex-row items-center text-center lg:text-left lg:w-1/2">
              <img src="../Images/logo2.png" alt="SoulSync Logo" class="h-24 w-24 lg:mr-4" />
              <div class="py-3 font-medium text-white w-2/3 flex flex-col text-xs">
                <h1 class="text-3xl projectName">SoulSync</h1>
                <span>
                ...
                <div class="social flex justify-center lg:justify-start items-center gap-x-4 mt-4">
                  ...
                  <a href="https://twitter.com/ExperienceSoulSync">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
          ...
          <div class="mt-8 copyRight flex items-center justify-center text-xs text-slate-300 flex-col">
            <p class='text-center' style = "color:white;" >Made with ❤️</p>
            <p class="text-indigo-900 font-bold">
              &copy; <span id="copyright-year"></span> SoulSync. All rights reserved.
            </p>
          </div>
  `
