...
<button
  ...
  <div class="mt-8 siteNav flex flex-col lg:flex-row ">
    ...
    <div class="flex flex-col lg:flex-row items-center text-center lg:text-left lg:w-1/2">
      <!-- <img src="../Images/New_Logo.svg" alt="SoulSync Logo" class="h-24 w-24 lg:mr-4" /> -->
      <img src="../Images/logo2.png" alt="SoulSync Logo" class="h-24 w-24 lg:mr-4 rounded-full" />
    ...
    <div
      ...
      <a href=".#blog" class="w-full lg:text-right text-right">
      <span
